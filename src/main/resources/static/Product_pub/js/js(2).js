    ...
    if ($(".quickBuy_Content").length > 0) {
        $(".quicktab,.quicktab_other").live("click", function () {
            ...
            if ($("#" + b).length > 0) {
                ...
                if ($.browser.msie && $.browser.version == "6.0") {
                    $(a).css({position: "relative", top: $(window).scrollTop() - $("#floatposition").offset().top})
                } else {
    ...
    if ($("#addToShoppingCar").length > 0 && $("#floatdiv").length > 0) {
        ...
        if (isClickQucikTab == false) {
            if (c >= $("#floatposition").offset().top && $(".quickBuy_Content").length > 0) {
                if ($.browser.msie && $.browser.version == "6.0") {
                    b.css({position: "relative", top: $(window).scrollTop() - $("#floatposition").offset().top})
                } else {
...
$(function () {
    ...
    function a(j) {
        ...
        var k = $(j).height();
        var l = $(j).width();
        $(j).css({position: "absolute", top: (m - k) / 2 + $(document).scrollTop(), left: (n - l) / 2})
    }
            ...
            if (j == "1") {
                if (isIE6) {
                    $("#carbox").css({
                        height: "95px",
                        position: "absolute",
                        top: $(".quickBuy_Content").offset().top + 35,
                        left: $(".quickBuy_Content").offset().left + $(".quickBuy_Content").width() - $("#carbox").width()
                    })
                } else {
                    $("#carbox").css({
                        height: "105px",
                        position: "fixed",
                        top: $(".quickBuy_Content").offset().top - $(document).scrollTop() + 35,
                        left: $(".quickBuy_Content").offset().left + $(".quickBuy_Content").width() - $("#carbox").width()
                    })
                }
            } else {
                if (j == "2") {
                    if (isIE6) {
                        $("#carbox").css({
                            height: "95px",
                            position: "absolute",
                            top: $(".Foot_buyContent").offset().top - 100,
                            left: $(".Foot_buytab01").offset().left + $(".Foot_buytab01").width() - $("#carbox").width()
                        })
                    } else {
                        $("#carbox").css({
                            height: "105px",
                    ...
                    $("#carbox").css({left: $(".danpinRight").offset().left, height: "295"});
                ...
                if (j == "1") {
                    ...
                    if (isIE6) {
                        $(".quickShoppingErrTips").css({
                            position: "absolute",
                            top: $(".quickBuy_Content").offset().top + 35,
                            left: $(".quickBuy_Content").offset().left + $(".quickBuy_Content").width() - $(".quickShoppingErrTips").width() - 6
                        })
                    } else {
                        $(".quickShoppingErrTips").css({
                            position: "fixed",
                    ...
                    if (j == "2") {
                        ...
                        if (isIE6) {
                            $(".quickShoppingErrTips").css({
                                position: "absolute",
                                top: $(".Foot_buyContent").offset().top - 12,
                                left: $(".Foot_buytab01").offset().left + $(".Foot_buytab01").width() - $(".quickShoppingErrTips").width() - 6
                            })
                        } else {
                            $(".quickShoppingErrTips").css({
                                position: "fixed",
    ...
    (function () {
        function p(w) {
            var s = $("#bigView");
            var t = $("#bigView img").css({width: "800px", height: "800px;"});
        ...
        function o(u) {
            ...
            $("#bigView img").css({left: y * -1, top: z * -1});
    ...
    $("#saleout").live("click", function () {
        ...
        ajaxIsLogined(function () {
            ...
            $.fn.popwindow({
                ...
                height: k,
                title: "到货通知我",
                href: "http://www.vancl.com/Product/ProductSaleOutNotify.aspx?oper=1&productCode=" + j + "&r=" + Math.random()
            })
        });
        return false
    });
    ...
    if (jQuery.fn.jscroll) {
        $(".selColorPolo").jscroll({
            W: "7px",
            Bg: "#DDD",
            Bar: {Bd: {Out: "#A10000", Hover: "#A10000"}, Bg: {Out: "#A10000", Hover: "#A10000", Focus: "#A10000"}},
            Btn: {btn: false}
        })
    }
    ...
    (function () {
        ...
        $("#share a").live("click", function () {
            ...
            $.fn.share({api: j[m], title: n, url: k(), pic: l});
            return false
        });
        function k() {
...
function addFavorite() {
    ...
    $.fn.popwindow.close();
    $("#collectbox").css({top: $(".dp_scbtn").offset().top - 100, left: $(".danpinRight").offset().left}).show();
    if (isIE6) {
...
function openLoginDiv(b) {
    var c = "http://login.vancl.com/popup/js(6).js";
...
function CommentVote(c) {
    ...
    $.ajax({url: c + "&t=" + Math.random(), dataType: "text"}).success(function (d) {
        if (d == "Y") {
            a.fadeOut(function () {
...
function showSize() {
    ...
    a.fn.share = function (e) {
        ...
        function d() {
            switch (e.api) {
                case"sina":
                    window.open(i + "?pic=" + e.pic[0] + "&title=" + encodeURIComponent(e.title) + "&url=" + encodeURIComponent(e.url) + "&rcontent=&appkey=2821020708", k, l);
                    break;
                case"sohu":
                    window.open(j + "?url=" + encodeURIComponent(e.url) + "&pic=" + e.pic.join(",") + "&title=" + encodeURIComponent(e.title) + "&content=utf8", k, l);
                    break;
                case"qq":
                    window.open(f + "&title=" + encodeURIComponent(e.title) + "&url=" + encodeURIComponent(e.url) + "&pic=" + e.pic.join("|") + "&rcontent=", k, l);
                    break;
                case"qqzone":
                    window.open(g + "?title=" + encodeURIComponent(e.title) + "&url=" + e.url + "&pics=" + e.pic.join("|") + "&rcontent=", k, l);
                    break;
                case"kaixin":
                    window.open(c + "&url=" + encodeURIComponent(e.url) + "&content=" + encodeURIComponent(e.title) + "&pic=" + e.pic.join(","), k, l);
                    break;
                case"renren":
                    window.open(h + "?title=" + encodeURIComponent(e.title) + "&url=" + encodeURIComponent(e.url) + "&pic=" + e.pic[0] + "&rcontent=", k, l);
                    break;
                case"douban":
                    window.open(b + "?image=" + e.pic[0] + "&href=" + e.url + "&name=" + encodeURIComponent(e.title), k, l);
                    break
            }
        }
    }
...
$(function () {
    function d(g) {
        if (history && history.pushState) {
            var h = {productcode: g};
            window.history.pushState(h, document.title, window.location.href.replace(/\d{7,8}\.html/, g + ".html"))
        }
    }
    ...
    window.onpopstate = function (g) {
        if (g.state) {
            ...
            var h = document.location.toString().match(/(\w{7,8}).html/);
    ...
    function a(j, i, g) {
        ...
        if (isIE6) {
            $("#loading").css({left: ie6.setLeft(h)})
        } else {
            $("#loading").css({left: h})
        }
        $("#loading").css({top: $(".bigImg").position().top, height: 260, width: $(".danpin_colLef").width()}).show();
        $.get("/styles/AjaxChangeProduct.aspx?productcode=" + j + "&point=" + i + "&ref=" + e("ref") + "&source=" + e("source") + "&fresh=" + Math.random(), function (o) {
            ...
            bindShowStarWindow();
            LimitPurchase();
            var v = location.href.replace(/\d{7,8}/, u);
            if (g) {
                d(u)
            }
...
VANCL.Global = {
    setLoginInfo: function () {
        ...
        $(window).bind("resize", {wideCallBack: c, narrowCallback: b}, function () {
            try {
...
VANCL.MiniCart = {
    config: {
        triggerId: "#shoppingCarNone",
        mcShoppingCartUrl: "http://shopping.vancl.com/mycart",
        mcProductTotalCount: 'span[car_product_total="shoppingCar_product_totalcount"]',
        gettting: 0,
        trackSBUSetting: 0
    }, init: function () {
        ...
        var b = {userId: "", indexPage: 1, pageSize: 7, shoppingcart: "", shoppingpointcart: "", shoppingPresent: ""};
        ...
        var j = 0, k = 0, g = this, a = this.config, c = [], h = "http://i.vanclimg.com/36";
        ...
        if (d && d.data && d.data.length > 0) {
            ...
            $.each(d.data, function (m) {
                var n = this["productImageUrl"], s = this["ProductUrl"], o = this["ProductName"],
                    q = this["ProductPrice"], v = this["Qty"], l = this["clothesCode"], r = this["productType"],
                    t = this["PromoteeId"], u = this["PromoteeIndex"], p = o;
                if (o.length > 14) {
                    p = o.substring(0, 14) + "…"
                }
        ...
        var k = this, a = this.config, d = $(c).parent();
        d.html("删除中");
        d.parent().css({opacity: 0.6});
        var e = {
            userId: "",
            indexPage: 1,
            pageSize: 7,
...
VANCL.Header.Category = {
    _config: {}, init: function (a) {
        this._config = jQuery.extend({
            mainMenu: "#V_Category_01",
            viewId: "#V_SubCategory_01",
            subViewCls: ".vanclSubNav",
            triggers: "li.item",
            hideDelay: 0.1
        }, a);
        ...
        a.viewer || $(a.viewId).length || (a.viewer = $(a.subViewerHtml).hide(), $("img[original]", a.viewer).lazyload({
            placeholder: "http://i.vanclimg.com/search/color3.gif",
            skip_invisible: true
        ...
        var d = this, a = this._config, b = a.subViews.eq(c);
        ...
        var h = this, c = h._config, d = $(c.triggers).eq(e), g = d.offset().left, f = $(c.container).offset(),
            b = g - f.left;
        var a = $(d).hasClass("itempic");
        if (a) {
            $(c.viewer).css({left: "260px"})
        } else {
            $(c.viewer).css({left: b + "px"})
        }
        ...
        $.ajax({
            ...
            url: c,
            dataType: "JSONP",
            data: jQuery.param({area: (window.area || ""), timespan: "20181126145335"}),
            jsonp: "jsoncallback",
    ...
    init: function (a) {
        ...
        b.prototype = {
            _initTab: function () {
                ...
                var c = this.config, d = $.trim($(e).attr("defaultkey")), f = $(e).val();
                if (c.onEnter) {
                    c.onEnter(e);
                    return
                }
                ...
                var c = this.config, d = $.trim($(f).attr("defaultkey"));
                if (c.onKeyUp) {
                    c.onKeyUp(e, f);
                    return
                }
                ...
                var j = this, e = j.config, f = $.trim($(e.txtKeyId).attr("defaultkey")), k = "", l = "search", c = "";
                ...
                e = e || "";
                f = f || "";
                var c = "", g = "http://vamr.vancl.com/click.ashx?";
                try {
                ...
                $.getScript(g)
            }, _getAutoCompleteData: function (e) {
                e = e || 0;
                var d = this.config, f = this;
                if ($.fn.autocomplete) {
                    var c = "http://page.vanclimg.com/autocompletehandler.ashx";
                    $(d.txtKeyId).unautocomplete();
                    $(d.txtKeyId).autocomplete(c, {
                        delay: 10,
                        dataType: "jsonp",
                        minChars: 1,
                        max: 13,
                        width: $(d.txtKeyId).outerWidth(),
                        matchContains: false,
                        selectFirst: false,
                        formatItem: function (k, g, j) {
                            var h = '<span class="ks-suggest-key">' + k.name;
                            if (k.categoryname) {
                                h += ' 在 <font color="#A10000"><b>' + k.categoryname + "</b></font> 中搜索"
                            }
                            h += "</span>";
                            if (k.count && parseInt(k.count) > 0) {
                                h += '<span class="ks-suggest-result">约' + k.count + "条</span>"
                            }
                            return h
                        },
                        formatMatch: function (j, g, h) {
                            return j.name
                        },
                        highlight: null
                    }).result(function (h, g, j, i) {
                        f._gotoSearch(g.name, g.categoryid, 3, i)
                    }).noresult(function (g) {
                        f._gotoSearch($(this).val(), null, 3)
                    })
                }
            }
        };
...
$(function () {
    function a() {
        ...
        $("#myVancl, #vanclMap, #vanclHelp, #vanclCustomer").mouseenter(function () {
            $(this).attr("class", "hover")
        }).mouseleave(function () {
            $(this).attr("class", "active")
        });
        $("#headerTopArea .payattention .vweixinbox").mouseenter(function () {
            $(".vweixinTip", this).show()
        }).mouseleave(function () {
            $(".vweixinTip", this).hide()
        });
        VANCL.Header.Search.init();
        VANCL.MiniCart.init();
        VANCL.Header.Category.init()
    }

    if ($("#Head").html() === "") {
        $.ajax({
            dataType: "text", url: "/public/common.aspx", success: function (e) {
...
$(function () {
    ...
    function a(e, d) {
        ...
        if (typeof(e) != "undefined") {
            f = "/styles/AjaxStyleAssesses.aspx?styleId=" + c + "&pageindex=" + e + "&type=" + feedbacktype + "&total=" + $("#feedbackcount" + feedbacktype).text() + "&ispic=0"
        }
        if (typeof(d) != "undefined") {
            f = d.href + "&total=" + $("#hidPlCount").val()
        }
        $.get(f, function (g) {
            if ($.trim($("#comments", g).html()) == "") {
                g = "<div style='text-align:center;padding-top:10px;color:#999'>还没有最新的此类评论，<a href='#' id='nocomment' style='display:none;'><<返回全部评论</a></div>";
...
function search(f) {
        ...
        if (g.code != null) {
            ...
            if (g.style != null) {
                ...
                if (g.cates != null) {
                    ...
                    $("#ct").attr("value", "cates:" + g.cates);
                    $(".keyword.keych").attr("class", "keyword");
                    $("#" + g.cates).addClass("keych")
                } else {
                    if (g.type != null) {
                        var i = $("#q").val().split(":");
                        g.q = $("#q").val();
                        ...
                        $("#ct").attr("value", "type:" + g.type);
                        $("#" + g.type).addClass("choosed")
                    } else {
                        if (g.start != null) {
                            var i = $("#q").val().split(":");
                            g.q = $("#q").val();
    ...
    if (g == undefined || (g.cates == null && g.type == null)) {
        $("#numFound").addClass("choosed")
    }
    var c = (g.cates == null) ? false : true;
    var a = "/styles/AjaxImpression";
    $.get(a, g, function (m, n, o) {
        if (n == "success") {
            h(m)
        } else {
            if (n == "error") {
    ...
    function h(q) {
        var m = jQuery.parseJSON(q);
        $.each(m, function (r, s) {
            if (r.valueOf() == "responseHeader") {
                $.each(s, function (t, u) {
                    if (t.valueOf() == "params") {
                        $.each(u, function (v, w) {
                            if (v.valueOf() == "start") {
                ...
                if (r.valueOf() == "response") {
                    $.each(s, function (t, u) {
                        if (t.valueOf() == "docs") {
                            n(u)
                        } else {
                            if (t.valueOf() == "numFound") {
                                d = parseInt(u)
                            }
                        }
                    })
                } else {
                    if (r.valueOf() == "facet_counts") {
                        $.each(s, function (t, u) {
                            if (t.valueOf() == "facet_queries") {
                                $.each(u, function (v, w) {
                                    p(v, w)
                                })
                            } else {
                                if (t.valueOf() == "facet_fields") {
                                    $(".outline").html("");
                                    $.each(u, function (v, w) {
                                        o(v, w)
                                    })
        ...
        function n(t) {
            $(".NewCommentDetail").html("");
            for (var s = 0; s < t.length; s++) {
                var r = $(l(t[s]));
                $(".NewCommentDetail").append(r);
                $(".NewCommentDetail").append($("<hr>"))
            }
        }
        ...
        function o(t, w) {
            if (t.valueOf() == "good") {
                ...
                for (var s = 0; s < w.length; s++) {
                    ...
                    u = w[s].substring(0, v);
                    r = w[s].substring(v);
                    $(".outline").append("<a href=\"javascript:search({cates:'" + r + "'})\"><span id='" + r + "' class='keyword'><font color='#F9842A'>" + u + "</fon></span></a>")
                }
            } else {
                if (t.valueOf() == "bad") {
                    var u, r, v;
                    for (var s = 0; s < w.length; s++) {
                        ...
                        u = w[s].substring(0, v);
                        r = w[s].substring(v);
                        $(".outline").append("<a href=\"javascript:search({cates:'" + r + "'})\"><span id='" + r + "' class='keyword'><font color='#A1A1A1'>" + u + "</fon></span></a>")
                    }
                }
            }
        }
    ...
    function l(n) {
        var r = "<div class='doc'>";
        r += "<div class='time'>";
        r += $.format.date(n.addtime, "yyyy/MM/dd HH:mm:ss");
        r += "</div><br/>";
        r += "[star:" + n.colligation + "]<br/>";
        r += "[said:" + n.said + "]<br/>";
        r += "[productcode:" + n.productcode + "]<br/>";
        if (c == true) {
            var p = n.realpos;
            var m = n.content;
            for (var o = p.length - 1; o > 0; o -= 2) {
                var q = m.slice(p[o - 1], p[o]);
                m = m.replace(q, "<font color='red'>" + q + "</font>")
            }
            r += m
        } else {
            r += n.content
    ...
    function e(s, w, o) {
        $("#paging").html("");
        var m = w / s + 1;
        var r = Math.max(1, m - 5);
        var q = Math.ceil(o / s);
        var v = Math.min(9, q - r);
        var p = r + v;
        var t = (m == 1) ? false : true;
        var u = (m >= p) ? false : true;
        if (t) {
            $("#paging").append("<a href='javascript:search({start:" + (w - s) + '});\'><span class="n">上一页</span></a>')
        }
        for (var n = r; n <= p; n++) {
            if (m == n) {
                $("#paging").append("<a href='javascript:search({start:" + ((n - 1) * s) + "});'><span class='pc curpage'>" + n + "</span></a>")
            } else {
                $("#paging").append("<a href='javascript:search({start:" + ((n - 1) * s) + '});\'><span class="pc">' + n + "</span></a>")
            }
        }
        if (u) {
            $("#paging").append("<a href='javascript:search({start:" + (w + s) + '});\'><span class="n">下一页</span></a>')
        }
        $("#paging").append("<span id='total'>一共找到 " + o + "条结果 ,共" + q + "页.</span>")
    }
}
function load(b) {
    var a = $("#base").val();
    $.get(a + "vancl/pc_show.txt", {limit: 25}, function (d, e, f) {
        var c = jQuery.parseJSON(d);
        $.each(c, function (h, j) {
            if (h.valueOf() == "pc") {
                for (var g = 0; g < j.length; g++) {
                    $("#code_show").append("<a href=\"javascript:search({code:'" + j[g].toString() + "'})\">" + j[g] + "</a><br/>")
                }
            }
        })
    });
    $.get(a + "vancl/style_show.txt", {limit: 25}, function (d, e, f) {
        var c = jQuery.parseJSON(d);
        $.each(c, function (h, j) {
            if (h.valueOf() == "styleId") {
                for (var g = 0; g < j.length; g++) {
                    $("#style_show").append('<a href="javascript:search({style:' + j[g].toString() + '})">' + j[g] + "</a><br/>")
                }
            }
        })
    })
...
function parse(a) {
    ...
    $.each(a, function (g, h) {
        if (g.valueOf() == "responseHeader") {
            ...
            if (g.valueOf() == "response") {
                $.each(h, function (i, j) {
                    if (i.valueOf() == "docs") {
                        b(j)
                    } else {
                        if (i.valueOf() == "numFound") {
                            numFound = parseInt(j)
                        }
                    }
                })
            } else {
                if (g.valueOf() == "facet_counts") {
                    $.each(h, function (i, j) {
                        if (i.valueOf() == "facet_queries") {
                            $.each(j, function (k, l) {
                                d(k, l)
                            })
                        } else {
                            if (i.valueOf() == "facet_fields") {
                                $(".outline").html("");
                                $.each(j, function (k, l) {
                                    c(k, l)
                                })
    ...
    paging(e, f, numFound);
    function d(g, h) {
        $("#numFound").html("全部评论 (" + numFound + ")");
        if (g.valueOf() == "colligation:[4 TO 5]") {
            $("#good").html("好评 (" + h + ")")
        } else {
            if (g.valueOf() == "colligation:[2 TO 3]") {
                $("#medium").html("中评 (" + h + ")")
            } else {
                if (g.valueOf() == "colligation:[* TO 1]") {
                    $("#bad").html("差评 (" + h + ")")
                }
            }
        }
    ...
    function c(j, m) {
        if (j.valueOf() == "good") {
            ...
            for (var h = 0; h < m.length; h++) {
                ...
                k = m[h].substring(0, l);
                g = m[h].substring(l);
                $(".outline").append("<a href=\"javascript:search({cates:'" + g + "'})\"><span id='" + g + "' class='keyword'><font color='#F9842A'>" + k + "</fon></span></a>")
            }
        } else {
            if (j.valueOf() == "bad") {
                var k, g, l;
                for (var h = 0; h < m.length; h++) {
                    ...
                    k = m[h].substring(0, l);
                    g = m[h].substring(l);
                    $(".outline").append("<a href=\"javascript:search({cates:'" + g + "'})\"><span id='" + g + "' class='keyword'><font color='#A1A1A1'>" + k + "</fon></span></a>")
                }
            }
        }
    }
...
function wrapdoc(a) {
    var b = "<div class='doc'>";
    b += "<div class='time'>";
    b += $.format.date(a.addtime, "yyyy/MM/dd HH:mm:ss");
    b += "</div><br/>";
    b += "[star:" + a.colligation + "]<br/>";
    b += "[said:" + a.said + "]<br/>";
    b += "[productcode:" + a.productcode + "]<br/>";
    b += a.content;
    b += "</div>";
    return b
}
function paging(g, l, c) {
    $("#paging").html("");
    var a = l / g + 1;
    var f = Math.max(1, a - 5);
    var e = Math.ceil(c / g);
    var k = Math.min(9, e - f);
    var d = f + k;
    var h = (a == 1) ? false : true;
    var j = (a >= d) ? false : true;
    if (h) {
        $("#paging").append("<a href='javascript:search({start:" + (l - g) + '});\'><span class="n">上一页</span></a>')
    }
    for (var b = f; b <= d; b++) {
        if (a == b) {
            $("#paging").append("<a href='javascript:search({start:" + ((b - 1) * g) + "});'><span class='pc curpage'>" + b + "</span></a>")
        } else {
            $("#paging").append("<a href='javascript:search({start:" + ((b - 1) * g) + '});\'><span class="pc">' + b + "</span></a>")
        }
    }
    if (j) {
        $("#paging").append("<a href='javascript:search({start:" + (l + g) + '});\'><span class="n">下一页</span></a>')
    }
    $("#paging").append("<span id='total'>一共找到 " + c + "条结果 ,共" + e + "页.</span>")
}
(function (c) {
    ...
    c.format = (function () {
        function n(q) {
            return a[parseInt(q, 10)] || q
        }

        function p(r) {
            var q = parseInt(r, 10) - 1;
            return e[q] || r
        }
        ...
        var m = function (t) {
            ...
            if (i.length === 3) {
                ...
                minute = i[1];
                second = i[2];
                return {time: s, hour: b, minute: minute, second: second, millis: r}
            } else {
                return {time: "", hour: "", minute: "", second: "", millis: ""}
            }
        };
        var k = function (t, r) {
            var s = r - String(t).length;
            for (var q = 0; q < s; q++) {
                t = "0" + t
            }
            return t
        ...
        return {
            date: function (D, v) {
                            ...
                            if (D.search(j()) != -1) {
                                ...
                                switch (g.length) {
                                    ...
                                    case 1:
                                        ...
                                        y = h[5] + h[6];
                                        s = h[8] + h[9];
                                        B = m(h[13] + h[14] + h[15] + h[16] + h[17] + h[18] + h[19] + h[20]);
                                        r = new Date(E, y - 1, s);
                                        t = r.getDay();
                                        break;
                                    default:
                    ...
                    for (var w = 0; w < v.length; w++) {
                        ...
                        switch (z) {
                            ...
                            case"yyy":
                                ...
                                break;
                            case"yy":
                                if (v.charAt(w + 1) == "y" && v.charAt(w + 2) == "y") {
                                    break
                                }
                                A += String(E).slice(-2);
                                z = "";
                            ...
                            case"H":
                                ...
                                A += parseInt(B.hour, 10);
                                z = "";
                                break;
                            case"hh":
                                b = (B.hour === 0 ? 12 : B.hour < 13 ? B.hour : B.hour - 12);
                                A += k(b, 2);
                                z = "";
                                break;
                            case"h":
                ...
                if (typeof t === "object") {
                    q = new Date(t.toString())
                }
                s = (((new Date()).getTime() - q.getTime()) / 1000);
                r = Math.floor(s / 86400);
                if (isNaN(r) || r < 0) {
                    return
                }
                if (s < 60) {
                                ...
                                if (s < 86400) {
                                    ...
                                    if (r === 1) {
                                        ...
                                        if (r < 7) {
                                            ...
                                            if (r < 31) {
                                                return Math.ceil(r / 7) + " weeks ago"
                                            } else {
                                                if (r >= 31) {
            ...
            }, toBrowserTimeZone: function (r, q) {
                return this.date(new Date(r), q || "MM/dd/yyyy HH:mm:ss")
            }
        }
    }())
}(jQuery));
...
jQuery(document).ready(function () {
    jQuery(".shortDateFormat").each(function (b, a) {
        if (jQuery(a).is(":input")) {
            jQuery(a).val(jQuery.format.date(jQuery(a).val(), jQuery.format.date.defaultShortDateFormat))
        } else {
            jQuery(a).text(jQuery.format.date(jQuery(a).text(), jQuery.format.date.defaultShortDateFormat))
        }
    });
    jQuery(".longDateFormat").each(function (b, a) {
        if (jQuery(a).is(":input")) {
            jQuery(a).val(jQuery.format.date(jQuery(a).val(), jQuery.format.date.defaultLongDateFormat))
        } else {
            jQuery(a).text(jQuery.format.date(jQuery(a).text(), jQuery.format.date.defaultLongDateFormat))
        }
    })
});
$(function () {
    ...
    function a(e, d) {
        window.location.hash = "anchorQuiz";
        window.location = window.location;
        var g = "";
        if (e != "undefined") {
...
$(function () {
    $(".showfile").live("click", function () {
        ...
        if (!window.replyfunction) {
            $.getScript("http://jsy.vanclimg.com/item/reply.js?v=20130305")
        }
        return false
    });
